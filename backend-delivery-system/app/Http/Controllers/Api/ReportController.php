...
class ReportController extends Controller
{
    ...
    public function ordersReport(Request $request): JsonResponse
    {
        ...
        return response()->json([
            'success' => true,
            'data'    => ['stats' => $stats, 'orders' => $orders],
        ]);
    }
    ...
    public function driverPerformance(Request $request, Driver $driver): JsonResponse
    {
        ...
        // Drivers can only view their own performance
        if (($user->role === 'driver' || $user->hasRole('driver')) && $user->driver?->id !== $driver->id) {
    ...
    public function generateDailyPerformance(Request $request): JsonResponse
    {
        ...
        return response()->json([
            'success' => true,
            'message' => "Performance report generated for {$date}.",
        ]);
    }
